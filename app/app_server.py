...
.kr-flag{width:18px;height:12px;border-radius:2px;box-shadow:0 0 0 1px rgba(255,255,255,.35);flex-shrink:0}
...
<header>
  ...
  <div class="headcopy"><h1>쇼파일 생성기 <span class="beta-badge">{{RELEASE_CHANNEL}}</span><span class="version-badge">v{{APP_VERSION}}</span><span class="kr-badge"><svg class="kr-flag" viewBox="0 0 72 48" xmlns="http://www.w3.org/2000/svg" aria-label="태극기"><rect width="72" height="48" fill="#fff"/><g transform="rotate(-33.69 36 24)"><circle cx="36" cy="24" r="12" fill="#0047A0"/><path d="M24 24 A12 12 0 0 1 48 24 A6.0 6.0 0 0 1 36 24 A6.0 6.0 0 0 0 24 24 Z" fill="#CD2E3A"/></g><g transform="translate(18.11 12.07) rotate(33.69)"><rect x="-6" y="-4.2" width="12" height="2" fill="#000"/><rect x="-6" y="-1.0" width="12" height="2" fill="#000"/><rect x="-6" y="2.2" width="12" height="2" fill="#000"/></g><g transform="translate(53.89 35.93) rotate(33.69)"><rect x="-6" y="-4.2" width="5.2" height="2" fill="#000"/><rect x="0.8" y="-4.2" width="5.2" height="2" fill="#000"/><rect x="-6" y="-1.0" width="5.2" height="2" fill="#000"/><rect x="0.8" y="-1.0" width="5.2" height="2" fill="#000"/><rect x="-6" y="2.2" width="5.2" height="2" fill="#000"/><rect x="0.8" y="2.2" width="5.2" height="2" fill="#000"/></g><g transform="translate(53.89 12.07) rotate(-33.69)"><rect x="-6" y="-4.2" width="5.2" height="2" fill="#000"/><rect x="0.8" y="-4.2" width="5.2" height="2" fill="#000"/><rect x="-6" y="-1.0" width="12" height="2" fill="#000"/><rect x="-6" y="2.2" width="5.2" height="2" fill="#000"/><rect x="0.8" y="2.2" width="5.2" height="2" fill="#000"/></g><g transform="translate(18.11 35.93) rotate(-33.69)"><rect x="-6" y="-4.2" width="12" height="2" fill="#000"/><rect x="-6" y="-1.0" width="5.2" height="2" fill="#000"/><rect x="0.8" y="-1.0" width="5.2" height="2" fill="#000"/><rect x="-6" y="2.2" width="12" height="2" fill="#000"/></g></svg>MADE IN KOREA</span></h1><div class="sub">AudioAZ &middot; 채널시트 &rarr; DM7 &middot; KLANG &middot; SuperRack</div></div>
  <div class="headtools">
